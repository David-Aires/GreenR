            ...
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <ul class="nav">
                        ...
                        <li class="scroll-to-section"><a href="../app/html/tracking.html" style="color: black"><i class="fa fa-database" style="color: black"></i> Données</a></li>
                    </ul>
        ...
        <div class="assistance" id="top">
            <div class="assistance-menu">
                ...
                <a onclick="afficherForm('.commande')">
                    <div>
                        <img src="../assets/images/31821.png">
                        Aide relative à une commande
                    </div>
                </a>
                <a onclick="afficherForm('.technique')">
                    <div>
                        <img src="../assets/images/boitier.png">
                ...
                <a onclick="afficherForm('.panne')">
                    <div>
                        <img src="../assets/images/reparation.png">
                ...
                <div class="formulaire">
                    <div class="commande">
                        ...
                        <p>Il se peut que votre mail de demande d'un boîtier n'ai toujours pas été lu par un membre de notre équipe.</p>
                        <p>
                        ...
                        <p>Si toutefois vous n'avez toujours pas reçu de réponse une semaine après l'envoie d'une commande, veuillez nous contacter via le formulaire ci-dessous.</p>
                        ...
                        <form class="form-style-9" action="https://formspree.io/meqqvnak" method="POST">
                            <ul>
                                <li>
                    ...
                    <div class="technique">
                        ...
                        <p>
                            Avant de nous contacter pour un problème technique, nous vous invitons à lire les différents point ci-dessous
                            afin de régler le problème lié à votre boîtier.
                        </p>
                        <p>
                            Si aucun des points suivant n'a permis de résoundre votre problème, vous pouvez nous contacter en remplissant le formulaire ci-dessous.
                        </p>
                        ...
                        <p>
                            Une petite lumière <strong style="color: blue">bleue</strong> (LED) se situant à l'arrière du boîtier vous permet de voir si il reste encore de la batterie dans le boîtier.
                        </p>
                        <p>
                        ...
                        <h4 style="padding-bottom: 3px">3) Nous contacter*</h4>
                        <i style="font-size: 12px;">* Après vérification des 2 étapes précendantes.</i>
                    ...
                    <div class="panne">
                        <h3>Nous renvoyez le boîtier</h3>
                        <p>
