            ...
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
                            <li class="scroll-to-section"><a href="#welcome" class="active"><i class='fas fa-home'></i> Home</a></li>
                            <li class="scroll-to-section"><a href="#about"><i class='far fa-bookmark'></i> About</a></li>
            ...
            <div class="container">
                <div class="row">
                    <div class="left-text col-lg-6 col-md-6 col-sm-12 col-xs-12" data-scroll-reveal="enter left move 30px over 0.6s after 0.4s">
                        <h1>Ajoutez un slogan ici!</h1>
                        <p>Grâce à la technologie, nous voulons améliorer le bien-être de tous, y compris la planète.</p>
                        <a href="app/examples/dashboard.html" class="main-button-slider">GreenR Viewer</a>
                    </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="right-image col-lg-7 col-md-12 col-sm-12 mobile-bottom-fix-big" data-scroll-reveal="enter right move 30px over 0.6s after 0.4s">
                    <img src="assets/images/right-image.gif" class="rounded img-fluid d-block mx-auto" alt="App">
                </div>
            </div>
        </div>
    </section>
