...
<div class="container">
    <div class="form-style-10">
        ...
        <h5>
            Afficher la moyenne d'une mesure précise entre deux dates d'une box :
        </h5>
        <p>
            Il faut utiliser le format de date '22-09-2008'.<br>
            Exemple : je veux afficher la <strong>moyenne</strong> de <strong>l'humidité</strong> de la table <strong>AIR_STAT</strong> de la box <strong>1</strong> entre le 22-09-2008 et le 01-11-2019 ->
            <a href="https://green-r.be/api/stats.php?box=1&table=AIR_STAT&mesure=HUMIDITY&from=22-09-2008&to=01-11-2019&action=moyenne" target="_blank">https://green-r.be/api/stats.php?box=1&table=AIR_STAT&mesure=HUMIDITY&from=22-09-2008&to=01-11-2019&action=moyenne</a>
        </p>
