      ...
      <Block flex style={styles.group}>
        ...
        <Block>
          <Block style={{ marginBottom: theme.SIZES.BASE }}>
            <Header search title="Localisation" navigation={this.props.navigation} titleColor="#5847bd"/>
          </Block>

          <Block style={{ marginBottom: theme.SIZES.BASE }}>
            <Header tabs={tabs.categories} search title="Title4" navigation={this.props.navigation} />
          </Block>
          ...
          <Block style={{ marginBottom: theme.SIZES.BASE }}>
            <Header
              options
              search
              title="Localisation spé"
              optionLeft="Code postal"
              optionRight="Nom"
